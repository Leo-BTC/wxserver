!function (t, e) {
	 ...
	 */
        var x = i(11), _ = i(124), b = i(89), w = i(23), S = i(125), M = i(12), T = i(15), I = i(57), A = i(27),
            L = i(3), C = i(7), D = i(76), P = i(1), k = i(18), z = i(20), O = i(44), E = P.each, R = 1e3, N = 5e3,
            V = 1e3, B = 2e3, G = 3e3, F = 4e3, H = 5e3, W = "__flag_in_main_process", Z = "_hasGradientOrPatternBg",
            q = "_optionUpdated";
        ...
        var Y = [], $ = {}, Q = [], K = [], J = [], tt = {}, et = {}, it = {}, nt = {}, ot = new Date - 0,
            rt = new Date - 0, at = "_echarts_instance_", st = {version: "3.3.1", dependencies: {zrender: "3.2.1"}};
        ...
        (function (e) {
            ...
            var r = "undefined", a = "undefined" == typeof window ? e : window,
                ...
                f = i(7), p = d.isObject, g = ["stackedOn", "hasItemOption", "_nameList", "_idList", "_rawData"],
                m = function (t, e) {
        ...
        "use strict";
        var n = i(1), o = i(9), r = i(7), a = i(12), s = i(56), l = i(11), u = o.encodeHTML, h = o.addCommas,
            c = a.extend({
                ...
                formatTooltip: function (t, e, i) {
                    ...
                    var a = this._data, s = this.getRawValue(t), l = n.isArray(s) ? r(s) : h(s), c = a.getName(t),
        ...
        "use strict";
        var n = i(17), o = i(5), r = i(73), a = i(8), s = i(33).devicePixelRatio,
        ...
        var n = i(4), o = i(9), r = i(32), a = Math.floor, s = Math.ceil, l = n.getPrecisionSafe, u = n.round,
            h = r.extend({
        ...
        var r = i(1), a = i(11), s = i(2), l = i(7), u = i(110), h = i(180), c = r.each, d = u.eachAxisDim,
            ...
            axisLine: function () {
                ...
                if (r) {
                    var s = i.axis, l = i.getModel("axisLabel"), c = l.getModel("textStyle"), d = l.get("margin"),
                        ...
                        g = m(e.labelRotation, l.get("rotate")) || 0;
                    g = g * v / 180;
                    for (var y = o(e, g, e.labelDirection), x = i.get("data"), b = [], w = a(i), S = i.get("triggerEvent"), M = 0; M < f.length; M++) if (!_(s, M, e.labelInterval)) {
                        ...
                        var I = T.getTextColor() || i.get("axisLine.lineStyle.color"), A = s.dataToCoord(f[M]),
                            L = [A, e.labelOffset + e.labelDirection * d], C = s.scale.getLabel(f[M]), D = new u.Text({
                                anid: "label_" + f[M],
                                style: {
                                    text: p[M],
        ...
        var u = i(13), h = i(22), c = i(1), d = i(119), f = i(117), p = c.each, g = h.ifAxisCrossZero,
            m = h.niceScaleExtent;
        i(120);
        var v = r.prototype;
	 ...
	 */
        var o = i(62), r = i(11), a = i(139), s = i(142), l = i(143), u = i(151), h = !r.canvasSupported,
            c = {canvas: i(141)}, d = {}, f = {};
        ...
        function f(t, e) {
            ...
            if (i && i.length && t.count()) {
                ...
                if (n && "cartesian2d" === e.type) {
                    ...
                    var h = l[0], c = l[l.length - 1], f = h.interval ? d(h.interval[0], s) : h.value,
                        p = c.interval ? d(c.interval[1], s) : c.value, g = p - f;
                    ...
                    var m = new y.LinearGradient(0, 0, 0, 0, u, (!0)), v = e.getAxis(a),
                        x = v.toGlobalCoord(v.dataToCoord(f)), _ = v.toGlobalCoord(v.dataToCoord(p));
        ...
        t.exports = b.extend({
            type: "line", init: function () {
                ...
                var r = t.coordinateSystem, a = this.group, l = t.getData(), u = t.getModel("lineStyle.normal"),
                    d = t.getModel("areaStyle.normal"), g = l.mapArray(l.getItemLayout, !0), m = "polar" === r.type,
                    v = this._coordSys, y = this._symbolDraw, x = this._polyline, _ = this._polygon,
                    b = this._lineGroup, w = t.get("animation"), S = !d.isEmpty(), M = s(r, l), T = t.get("showSymbol"),
                ...
                var r = this._polyline, a = this._polygon, s = t.hostModel,
                    l = v(this._data, t, this._stackedOnPoints, e, this._coordSys, i), u = l.current,
        ...
        t.exports = function (t, e, i, n) {
            ...
            l.each(function (i) {
                ...
                var D = g.getModel("textStyle").getFont(), P = g.get("rotate") ? b < 0 ? -_ + Math.PI : -_ : 0,
                    k = t.getFormattedLabel(i, "normal") || l.getName(i), z = r.getBoundingRect(k, D, d, "top");
                h = !!P, f.label = {
                    x: n,
                    y: o,
                    position: m,
        ...
        var o = i(1), r = i(3), a = i(50), s = a.ifIgnoreOnTick, l = a.getInterval,
        ...
        var N = i(20), V = i(1), B = i(8), G = i(3), F = i(115), H = i(45), W = V.curry, Z = V.each, q = V.map,
        ...
        var c = i(1), d = i(7), f = i(10), p = c.each, g = c.filter, m = c.map, v = c.isArray, y = c.indexOf,
            x = c.isObject, _ = i(12), b = i(126), w = "\0_ec_inner", S = f.extend({
        ...
        var c = i(33), d = i(1), f = i(47), p = i(8), g = i(44), m = i(140), v = i(60), y = 5, x = new p(0, 0, 0, 0),
        ...
        var u = i(28).CMD, h = i(84), c = i(147), d = i(85), f = i(146), p = i(61).normalizeRadian, g = i(17),
        ...
        var a = i(6), s = i(28), l = i(169), u = i(19),
        ...
        function a(t, e) {
            ...
            if (n) {
                var r = e || 0 === n[0] && 100 === n[1], a = !e && l.getPixelPrecision(o, [0, 500]),
                    s = !(e || a < 20 && a >= 0), u = e || r || s;
        ...
        var o = i(1), r = i(3), a = i(83), s = i(41), l = r.Rect, u = i(4), h = u.linearMap, c = i(13), d = i(80),
            ...
            w = ["line", "bar", "candlestick", "scatter"], S = s.extend({
                type: "dataZoom.slider", init: function (t, e) {
                    ...
                    function t(t) {
                        var e = r.getTransform(i.handles[t].parent, this.group),
                            s = r.transformDirection(0 === t ? "right" : "left", e), l = this._handleWidth / 2 + b,
                            h = r.applyTransform([u[t] + (0 === t ? -l : l), this._size[1] / 2], e);
                        n[t].setStyle({
                            x: h[0],
                            y: h[1],
        ...
        r.onclick = function (t, e) {
            var i = this.model, n = i.get("name") || t.get("title.0.text") || "echarts",
                o = document.createElement("a"), r = i.get("type", !0) || "png";
        ...
        var l = i(1), u = i(18), h = i(24), c = i(9), d = l.each, f = c.toCamelCase, p = i(11),
            g = ["", "-webkit-", "-moz-", "-o-"],
        ...
        i(2).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                function s(i, n, o) {
                    var a = e.getAxis(i), s = a.getBandWidth(), u = o[1] - o[0],
                        h = "x" === i ? r(n[0] - s / 2, o[0], s, u) : r(o[0], n[1] - s / 2, u, s),
                ...
                function r(i, n, r) {
                    var s = e.getAxis(), u = s.orient,
                        h = "horizontal" === u ? o(n[0], r[0], n[0], r[1]) : o(r[0], n[1], r[1], n[1]),
                ...
                var a = this._tooltipModel, s = t.getBaseAxis(), l = "x" === s.dim || "radius" === s.dim ? 0 : 1,
                ...
                if (c.payloadBatch && !o && d.dispatchAction({
                    ...
                    if (o) u(r || a.get("position"), i[0], i[1], this._tooltipContent, p, null, d); else {
                        var g = h[0].dataIndexInside,
                            m = "time" === s.type ? s.scale.getLabel(n[l]) : e[0].getData().getName(g),
                            v = (m ? m + "<br />" : "") + f.map(e, function (t, e) {
                ...
                var u = this._tooltipModel, h = t.getModel("tooltip", u), c = new x(s, h, h.ecModel),
        ...
        if (!i(11).canvasSupported) {
            var n = i(5), o = i(8), r = i(28).CMD, a = i(18), s = i(16), l = i(75), u = i(37), h = i(48), c = i(74),
                d = i(6), f = i(29), p = i(170), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos,
                    ...
                    for (a = 0; a < t.length;) {
                        switch (o = t[a++], n = "", i = 0, o) {
                            ...
                            case d:
                                ...
                                a++;
                                var F = t[a++], H = O + y(V) * R, W = E + x(V) * N, S = O + y(B) * R, I = E + x(B) * N,
                                    Z = F ? " wa " : " at ";
            ...
            h.prototype.brushVML = function (t) {
                ...
                if (o) {
                    var u = n.x || 0, h = n.y || 0, c = n.width, d = n.height, f = n.sWidth, v = n.sHeight,
                        y = n.sx || 0, x = n.sy || 0, M = f && v, T = this._vmlEl;
        ...
        var n = i(2), o = i(1), r = i(11), a = i(383), s = i(71), l = i(173), u = s.mapVisual, h = i(7),
        ...
        var o = i(39), r = i(95), a = i(79), s = i(3), l = i(268), u = i(1), h = ["itemStyle", "normal", "opacity"],
        ...
        var n = i(14), o = i(15), r = i(1), a = i(30), s = i(9), l = s.encodeHTML, u = s.addCommas, h = i(66),
            c = i(172), d = o.extend({
                type: "series.map",
                layoutMode: "box",
                needsDrawMap: !1,
        ...
        var a = i(1), s = i(3), l = i(45), u = i(78), h = i(312), c = i(79), d = i(8), f = i(19), p = i(381),
        ...
        var p = i(1), g = i(4), m = i(13), v = i(78), y = i(8), v = i(78), x = Math.max, _ = Math.min,
        ...
        var o = i(1), r = i(50), a = i(113), s = i(3), l = ["axisLine", "axisLabel", "axisTick", "axisName"],
        ...
        var o = i(1), r = i(3), a = i(50), s = ["axisLine", "axisLabel", "axisTick", "axisName"],
        ...
        var o = i(50), r = i(1), a = i(3), s = o.getInterval, l = o.ifIgnoreOnTick,
        ...
        var h = i(2), c = i(173), d = i(1), f = i(8), p = i(329), g = i(83), m = i(114), v = ["inBrush", "outOfBrush"],
        ...
        var s = i(1), l = i(3), u = i(13), h = i(344), c = i(342), d = i(26), f = i(22), p = i(8), g = i(19), m = i(4),
        ...
        var l = i(232), u = i(3), h = i(1), c = i(4), d = i(80), f = i(87), p = i(233), g = i(7), m = c.linearMap,
