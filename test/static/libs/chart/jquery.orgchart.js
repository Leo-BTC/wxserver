...
(function($) {
  ...
  function createNode(nodeData, opts) {
    ...
    var $nodeDiv = $('<div>', {'id': nodeData[opts.nodeId]})
	  ...
	  .append(typeof opts.nodeText !== 'undefined' ? '<div class="content">' + nodeData[opts.nodeText] + '</div>' : '')
	  .append(typeof opts.nodeState !== 'undefined' ? '<div class="content">' + nodeData[opts.nodeState] + '</div>' : '');
